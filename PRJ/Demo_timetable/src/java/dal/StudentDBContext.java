...
public class StudentDBContext extends DBContext<Student> {
    ...
    public void insert(Student model) {
        try {
            ...
            //get student id for new student
            ...
            for (Skill skill : model.getSkills()) {
                ...
                stm_register_skill.setInt(1, skill.getId());
                stm_register_skill.setInt(2, model.getId());
    ...
    public void update(Student model) {
        try {
            ...
            String sql_remove_skill = "DELETE Student_Skill WHERE [sid] = ?";
            PreparedStatement stm_remove_skill = connection.prepareStatement(sql_remove_skill);
    ...
    public Student get(int id) {
        try {
            String sql = "SELECT s.sid,s.sname,s.gender,s.dob,s.created_time,d.did,d.dname,\n"

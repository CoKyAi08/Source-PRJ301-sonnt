...
public class StudentDBContext extends DBContext<Student> {
    ...
    public void update(Student model) {
        try {
            ...
            String sql_remove_sk = "DELETE Skill_Student WHERE [sid]=?";
            PreparedStatement stm_remove_sk = connection.prepareStatement(sql_remove_sk);
            stm_remove_sk.setInt(1, model.getId());
            stm_remove_sk.executeUpdate();
